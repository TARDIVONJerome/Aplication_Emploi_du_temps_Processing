  ...
  for (int u=0; u<LSTEVENTS.length; u++) {
    ...
    for (int i=LSTEVENTS[u].length-1; i>0; i--) {
      if (LSTEVENTS[u][i]!=null && LSTEVENTS[u][i].timeStart!=null &&  LSTEVENTS[u][i].timeEnd!=null) {
        ...
        if (parseInt(LSTEVENTS[u][i].timeStart.substring(9, 11))+decalageH<10)LSTEVENTS[u][i].timeStart=LSTEVENTS[u][i].timeStart.substring(0, 9)+"0"+(parseInt(LSTEVENTS[u][i].timeStart.substring(9, 11))+decalageH)+LSTEVENTS[u][i].timeStart.substring(11, event.timeStart.length()-1);
        else LSTEVENTS[u][i].timeStart=LSTEVENTS[u][i].timeStart.substring(0, 9)+(parseInt(LSTEVENTS[u][i].timeStart.substring(9, 11))+decalageH)+LSTEVENTS[u][i].timeStart.substring(11, event.timeStart.length()-1);
        if (parseInt(LSTEVENTS[u][i].timeEnd.substring(9, 11))+decalageH<10)LSTEVENTS[u][i].timeEnd=LSTEVENTS[u][i].timeEnd.substring(0, 9)+"0"+(parseInt(LSTEVENTS[u][i].timeEnd.substring(9, 11))+decalageH)+LSTEVENTS[u][i].timeEnd.substring(11, event.timeStart.length()-1);
        else LSTEVENTS[u][i].timeEnd=LSTEVENTS[u][i].timeEnd.substring(0, 9)+(parseInt(LSTEVENTS[u][i].timeEnd.substring(9, 11))+decalageH)+LSTEVENTS[u][i].timeEnd.substring(11, event.timeStart.length()-1);
      }}
    }
  }
}
